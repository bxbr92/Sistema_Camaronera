...
(function (e) {
    ...
    }) : "object" === typeof exports ? module.exports = function (B, y) {
        B || (B = window);
    ...
    var t = e.fn.dataTable, O = 0, P = 0, z = t.ext.buttons, v = function (a, b) {
    ...
    e.extend(v.prototype, {
        action: function (a, b) {
            ...
            a = this._nodeToButton(a);
            e(a.node).addClass(this.c.dom.button.disabled).attr("disabled",
                !0);
            return this
        }, destroy: function () {
            ...
            b.conf.destroying = !0;
            b.conf.destroy &&
            b.conf.destroy.call(d.button(a), d, e(a), b.conf);
            ...
            var d = this.s.dt, h = e(c.node), g = function (l) {
            ...
            var a = this, b = this.s.dt,
                c = b.settings()[0], d = this.c.buttons;
            ...
            var k = this.s.dt, n = 0, p = Array.isArray(b) ? b : [b];
            b === q && (p = Array.isArray(c) ? c : [c]);
            c = 0;
            for (var r = p.length; c < r; c++) {
                var f = this._resolveExtends(p[c]);
                if (f) if (b = f.config !== q && f.config.split ? !0 : !1, Array.isArray(f)) this._expandButton(a,
                    ...
                    if (m) {
                        ...
                        if (m.conf.buttons || m.conf.split) {
                            ...
                            if (m.conf.split) for (var u = 0; u < m.conf.split.length; u++) "object" === typeof m.conf.split[u] && (m.conf.split[c].parent = l, m.conf.split[u].collectionLayout === q &&
            ...
            var h = this.c.dom.button, g = this.c.dom.buttonLiner,
                l = this.c.dom.collection, k = this.c.dom.splitCollection, n = this.c.dom.splitDropdownButton,
                p = this.s.dt, r = function (w) {
            ...
            if (a.hasOwnProperty("html")) var f = e(a.html); else {
                var m = function (w, A, C, F) {
                    F.action.call(A.button(C), w, A, C, F);
                    e(A.table().node()).triggerHandler("buttons-action.dt",
                        [A.button(C), A, C, F])
                };
                l = a.tag || h.tag;
                var u = a.clickBlurs === q ? !0 : a.clickBlurs;
                f = e("<" + l + "/>").addClass(h.className).addClass(d ? this.c.dom.splitDropdownButton.className : "").attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function (w) {
                    w.preventDefault();
                ...
                g.tag ? (l = e("<" + g.tag + "/>").html(r(a.text)).addClass(g.className), "a" === g.tag.toLowerCase() && l.attr("href", "#"), f.append(l)) : f.html(r(a.text));
            ...
            if (c) {
                ...
                var G = function (w, A, C, F) {
                    ...
                    E = e('<button class="' + this.c.dom.splitDropdown.className + ' dt-button"><span class="dt-btn-split-drop-arrow">' + this.c.dom.splitDropdown.text + "</span></button>").on("click.dtb", function (w) {
                        w.preventDefault();
            ...
            if (!b._buttonsHandled) {
                var c = function (d) {
                    for (var h = 0, g = d.length; h < g; h++) {
                        var l = d[h].conf, k = d[h].node;
                        l.key && (l.key === a ? (b._buttonsHandled = !0, e(k).click()) : !e.isPlainObject(l.key) || l.key.key !== a || l.key.shiftKey && !b.shiftKey || l.key.altKey && !b.altKey || l.key.ctrlKey && !b.ctrlKey || l.key.metaKey && !b.metaKey || (b._buttonsHandled = !0, e(k).click()));
            ...
            var b = this.s.dt, c, d = function (k) {
        ...
        _popover: function (a, b, c) {
            ...
            c.length && (g = c.eq(0), l());
            c = e("<div/>").addClass("dt-button-collection").addClass(h.collectionLayout).addClass(h.splitAlignClass).css("display",
                "none");
            ...
            if ("absolute" ===
                ...
                d = e(b.node()).position();
                c.css({
                    top: e(e(b[0].node).parent()[0]).hasClass("dt-buttons") ? d.top + g.outerHeight() : n.top + g.outerHeight(),
                    left: n.left
                });
                n = c.outerHeight();
                var p = k.offset().top + k.height();
                p = d.top + g.outerHeight() + n - p;
                var r = d.top - n, f = k.offset().top;
                d = d.top - n - 5;
                ...
                if (c.hasClass(h.rightAlignClassName) || c.hasClass(h.leftAlignClassName) || c.hasClass(h.splitAlignClass) || "dt-container" === h.align) {
                    var u = r;
                    g.hasClass("dt-btn-split-wrapper") && 0 < g.children("button.dt-btn-split-drop").length && (m = g.children("button.dt-btn-split-drop").offset().left, f = g.children("button.dt-btn-split-drop").outerWidth(), u = m + f);
                    f = 0;
                    if (c.hasClass(h.rightAlignClassName)) f = r - p, d > n + f && (d -= n + f, k -= p + f, f = d > k ? f + k : f + d); else if (c.hasClass(h.splitRightAlignClassName)) f = u - p, d > n + f && (d -= n + f, k -= p +
                        f, f = d > k ? f + k : f + d); else if (c.hasClass(h.splitLeftAlignClassName)) {
            ...
            e("body").on("click.dtb-collection",
                function (x) {
                    var D = e.fn.addBack ? "addBack" : "andSelf", G = e(x.target).parent()[0];
    ...
    v.background = function (a, b, c, d) {
        c === q && (c = 400);
        d || (d = y.body);
        a ? I(e("<div/>").addClass(b).css("display",
            "none").insertAfter(d), c) : J(e("div." + b), c, function () {
            e(this).removeClass(b).remove()
        })
    };
    v.instanceSelector = function (a, b) {
        if (a === q || null === a) return e.map(b, function (g) {
            return g.inst
        });
        var c = [], d = e.map(b, function (g) {
            return g.name
        }), h = function (g) {
            if (Array.isArray(g)) for (var l = 0, k = g.length; l < k; l++) h(g[l]); else "string" === typeof g ? -1 !== g.indexOf(",") ? h(g.split(",")) : (g = e.inArray(g.trim(), d), -1 !== g && c.push(b[g].inst)) : "number" === typeof g && c.push(b[g].inst)
        };
        h(a);
        return c
    };
    v.buttonSelector = function (a, b) {
        for (var c =
            [], d = function (k, n, p) {
            for (var r, f, m = 0, u = n.length; m < u; m++) if (r = n[m]) f = p !== q ? p + m : m + "", k.push({
                node: r.node,
                name: r.conf.name,
                idx: f
            }), r.buttons && d(k, r.buttons, f + "-")
        }, h = function (k, n) {
            var p, r = [];
            d(r, n.s.buttons);
            ...
            if (Array.isArray(k) || k instanceof e) for (f = 0, p = k.length; f < p; f++) h(k[f], n); else if (null === k || k === q || "*" === k) for (f = 0, p = r.length; f < p; f++) c.push({
                inst: n,
                node: r[f].node
            }); else if ("number" === typeof k) c.push({inst: n, node: n.s.buttons[k].node}); else if ("string" ===
                typeof k) if (-1 !== k.indexOf(",")) for (r = k.split(","), f = 0, p = r.length; f < p; f++) h(r[f].trim(), n); else if (k.match(/^\d+(\-\d+)*$/)) f = e.map(r, function (m) {
                return m.idx
            }), c.push({
                inst: n,
                node: r[e.inArray(k, f)].node
            }); else if (-1 !== k.indexOf(":name")) for (k = k.replace(":name", ""), f = 0, p = r.length; f < p; f++) r[f].name === k && c.push({
                inst: n,
                node: r[f].node
            }); else e(f).filter(k).each(function () {
                c.push({inst: n, node: this})
            }); else "object" === typeof k && k.nodeName && (r = e.inArray(k, f), -1 !== r && c.push({
                inst: n,
                node: f[r]
            }))
        }, g = 0, l = a.length; g <
    ...
    e.extend(z, {
        collection: {
            ...
            else for (var d = 0; d < a.length; d++) {
                var h = a[d];
                e.isPlainObject(h) ? (b.push(h.value), c.push(h.label)) : (b.push(h), c.push(h))
            }
            return {
                extend: "collection", text: function (g) {
                    return g.i18n("buttons.pageLength", {"-1": "Show all rows", _: "Show %d rows"}, g.page.len())
                }, className: "buttons-page-length", autoClose: !0, buttons: e.map(b, function (g, l) {
                    return {
                        text: c[l], className: "button-page-length", action: function (k, n) {
                            n.page.len(g).draw()
                        }, init: function (k, n, p) {
                            var r = this;
                            n = function () {
    ...
    t.Api.register("button()", function (a,
                                         b) {
        a = this.buttons(a, b);
    ...
    t.Api.registerPlural("buttons().active()", "button().active()", function (a) {
        return a === q ? this.map(function (b) {
    ...
    t.Api.registerPlural("buttons().collectionRebuild()", "button().collectionRebuild()",
        function (a) {
    ...
    t.Api.registerPlural("buttons().processing()",
    ...
    t.Api.register("button().add()", function (a, b) {
        var c = this.context;
        c.length && (c =
            v.instanceSelector(this._groupSelector, c[0]._buttons), c.length && c[0].add(b, a));
    ...
    t.Api.register("buttons.info()", function (a, b, c) {
        var d = this;
        if (!1 === a) return this.off("destroy.btn-info"), J(e("#datatables_buttons_info"),
            400, function () {
                e(this).remove()
    ...
    t.Api.register("buttons.exportInfo()", function (a) {
        ...
        b = K(a.title);
        b = null === b ? null : -1 !== b.indexOf("*") ?
            b.replace("*", e("head > title").text() || "Exported data") : b;
        return {
            filename: c,
            title: b,
    ...
    var K = function (a) {
        ...
        }).toArray() : null, h = e.extend({}, c.modifier);
